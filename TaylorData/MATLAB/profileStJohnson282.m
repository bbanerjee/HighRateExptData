...
%
ax = [[6744 8874];[6744 7418]];
dat= [[6744 8874];[6130 8874];[6219 8616];[6297 8396];[6303 8158];[6299 7919];...
      [6294 7646];[6528 7646];[6744 7646]];
...
%
fid = fopen('taylorStJohnsonCook282.dat','w');
for i=1:n
  fprintf(fid,'%f %f\n',dat(i,1),dat(i,2));
end
fclose(fid);
