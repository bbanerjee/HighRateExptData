...
% seqv1 = seq1(:,4)/1.0e6;
% seqv1 = seqv1;
% plot(e331, seqv1, '--','color', color(1,:), 'LineWidth', 2.5);
% hold on;
% 
% load SigEpsEp4000s298KLee.dat.raw
% dat = SigEpsEp4000s298KLee;
% p6 = plotSigEp(dat, marker(6,:), color(6,:));
%   
...
% seqv2 = seq2(:,4)/1.0e6;
% seqv2 = seqv2;
% plot(e332, seqv2, '--','color',color(6,:), 'LineWidth', 2.5);
...
load seq_MTS_adi_29000_298K.dat;
load ep_MTS_adi_29000_298K.dat;
seq4 = seq_MTS_adi_29000_298K;
eps4 = ep_MTS_adi_29000_298K;
e334 = eps4(:,5);
seqv4 = seq4(:,4)/1.0e6;
seqv4 = seqv4;
% 
p8 = plot(e334, seqv4, '--', 'color',color(8,:), 'LineWidth', 2.5);

set(gca, 'LineWidth', 3, 'FontName', 'bookman', 'FontSize', 14);
set(gca, 'XLim',[0 0.4],'YLim',[0 600]);
xlabel('True Plastic Strain', 'FontName', 'bookman', 'FontSize', 16);
ylabel('True Stress (MPa) ', 'FontName', 'bookman', 'FontSize', 16);
title('6061-T6 Al: Comparison of experimental data with simulations using MTS model','FontName', 'bookman', 'FontSize', 16);

%   legend([p1], '298 K 3000/s (Lee et al.)',1);
  legend([p7,p8], 'Expt. 298 K 29000/s (Ramesh et al.)','Sim. 298 K 29000/s (MTS model)',1);
