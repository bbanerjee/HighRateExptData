...
p8 = plotSigEp(dat, marker(6,:), color(6,:));
...
seqv3 = seq3(:,4)/1.0e6;
seqv3 = seqv3;
p9 = plot(e333, seqv3, '-.','color',color(6,:), 'LineWidth', 2.5);
...
set(gca, 'XLim',[0 0.35],'YLim',[0 500]);
...
%   legend([p1], '298 K 3000/s (Lee et al.)',1);
  legend([p1, p2, p8,p9], 'Expt. Data 298 K 3000/s (Lee et al.)',...
                          'Sim. 298 K 3000/s (MTS model)',...
                          'Expt. Data 298 K 8000/s (Lesuer et al.)',...
                          'Simu. 298K 8000/s (MTS model)',4);
...
function [p] = plotSigEp(dat, marker, color )
  ...
  set(p,'LineWidth',2.5,'Color',color,'MarkerSize',6,'Marker',marker);
