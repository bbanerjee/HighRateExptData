...
function plotTheta(dat, color, marker, fit)
  ...
  %[xg, yg, zg0] = plotThetaGridFit(x, y, z0);
  %[C_theta0] = plotThetaSqFit(x, y, z0);
  %[C_theta0] = plotThetaPolyFit(x, y, z0);
  [C_theta0] = plotThetaPoly4Fit(x, y, z0);
...
%
function [xg, yg, zg0] = plotThetaGridFit(x, y, z0)
  ...
  % Plot the surfaces
  drawSurface(xg, yg, zg0);

%------------------------------------------------------------------
% Plot Theta as a function of T and edot and fit 2-D surface
%
function [C_theta0] = plotThetaPolyFit(x, y, z0)
...
% Plot Theta as a function of T and edot and fit 2-D surface
%
function [C_theta0] = plotThetaPoly4Fit(x, y, z0)
...
%   using Sqrt fit
%
function [C_theta0] = plotThetaSqFit(x, y, z0)
...
% Draw the surfaces
%
function drawSurface(xg, yg, zg0)
