...
%
function calcVoceLaw

  fid = fopen('StDataVoceFit.dat','w');

  [theta30_1] = plotTangJCRc30Tension;
  %theta1 = theta30_1(:,2) + theta30_1(:,1);
  %theta30_1(:,2) = theta30_1(:,2) - theta1;
  [theta30_2] = plotTangJCRc30Shear;
  %theta1 = theta30_2(:,2) + theta30_2(:,1);
  %theta30_2(:,2) = theta30_2(:,2) - theta1;
  ...
  fprintf(fid, '30\n a_0 = %g;\n a_1 = %g;\n a_2 = %g;\n a_3 = %g;\n', ...
          a0_30(1), a0_30(2), a0_30(3), a0_30(4));
  fprintf(fid, ' aIV_0 = %g;\n aIV_1 =  %g;\n aIV_2 = %g;\n aIV_3 =  %g;\n', ...
          aIV_30(1), aIV_30(2), aIV_30(3), aIV_30(4));
  %pause

  [theta38_1] = plotTangLarsonRc38;
  %theta1 = theta38_1(:,2) + theta38_1(:,1);
  %theta38_1(:,2) = theta38_1(:,2) - theta1;
  [theta38_2] = plotTangLYRc38500;
  %theta1 = theta38_2(:,2) + theta38_2(:,1);
  %theta38_2(:,2) = theta38_2(:,2) - theta1;
  [theta38_3] = plotTangLYRc381500;
  %theta1 = theta38_3(:,2) + theta38_3(:,1);
  %theta38_3(:,2) = theta38_3(:,2) - theta1;
  [theta38_4] = plotTangLYRc382500;
  %theta1 = theta38_4(:,2) + theta38_4(:,1);
  %theta38_4(:,2) = theta38_4(:,2) - theta1;
  ...
  [theta0fit38Lo, thetaIVfit38Lo] = plotThetavsEdot(theta38Lo, '4340 Steel Rc 38');
  [a0_38Lo, aIV_38Lo] = plotThetavsT(theta38Lo, theta0fit38Lo, thetaIVfit38Lo,  '4340 Steel Rc 38');
  fprintf(fid, '38\n a_0 = %g;\n a_1 = %g;\n a_2 = %g;\n a_3 = %g;\n', ...
          a0_38Lo(1), a0_38Lo(2), a0_38Lo(3), a0_38Lo(4));
  fprintf(fid, ' aIV_0 = %g;\n aIV_1 =  %g;\n aIV_2 = %g;\n aIV_3 =  %g;\n', ...
          aIV_38Lo(1), aIV_38Lo(2), aIV_38Lo(3), aIV_38Lo(4));
  [theta0fit38Hi, thetaIVfit38Hi] = plotThetavsEdot(theta38Hi, '4340 Steel Rc 38');
  [a0_38Hi, aIV_38Hi] = plotThetavsT(theta38Hi, theta0fit38Hi, thetaIVfit38Hi,  '4340 Steel Rc 38')
  fprintf(fid, 'High T\n a_0 = %g;\n a_1 = %g;\n a_2 = %g;\n a_3 = %g;\n', ...
          a0_38Hi(1),  a0_38Hi(2), a0_38Hi(3), a0_38Hi(4));
  fprintf(fid, ' aIV_0 = %g;\n aIV_1 =  %g;\n aIV_2 = %g;\n aIV_3 =  %g;\n', ...
          aIV_38Hi(1), aIV_38Hi(2), aIV_38Hi(3), aIV_38Hi(4));
  %pause

  [theta45_1] = plotTangChiRc45_0001;
  %theta1 = theta45_1(:,2) + theta45_1(:,1);
  %theta45_1(:,2) = theta45_1(:,2) - theta1;
  [theta45_2] = plotTangChiRc45_1000;
  %theta1 = theta45_2(:,2) + theta45_2(:,1);
  %theta45_2(:,2) = theta45_2(:,2) - theta1;
  ...
  fprintf(fid, '45\n a_0 = %g;\n a_1 = %g;\n a_2 = %g;\n a_3 = %g;\n', ...
          a0_45(1),  a0_45(2), a0_45(3), a0_45(4));
  fprintf(fid, ' aIV_0 = %g;\n aIV_1 =  %g;\n aIV_2 = %g;\n aIV_3 =  %g;\n', ...
          aIV_45(1), aIV_45(2), aIV_45(3), aIV_45(4));
  %pause

  [theta49_1] = plotTangChiRc49_0001;
  %theta1 = theta49_1(:,2) + theta49_1(:,1);
  %theta49_1(:,2) = theta49_1(:,2) - theta1;
  [theta49_2] = plotTangChiRc49_1000;
  %theta1 = theta49_2(:,2) + theta49_2(:,1);
  %theta49_2(:,2) = theta49_2(:,2) - theta1;
  ...
  fprintf(fid, '49\n a_0 = %g;\n a_1 = %g;\n a_2 = %g;\n a_3 = %g;\n', ...
          a0_49(1),  a0_49(2), a0_49(3), a0_49(4));
  fprintf(fid, ' aIV_0 = %g;\n aIV_1 =  %g;\n aIV_2 = %g;\n aIV_3 =  %g;\n', ...
          aIV_49(1), aIV_49(2), aIV_49(3), aIV_49(4));
  %pause
  ...
  a02_mean = mean(a0_2);
  a03_mean = mean(a0_3);
  aIV0_mean = mean(aIV_0);
  aIV1_mean = mean(aIV_1);
  aIV2_mean = mean(aIV_2);
  aIV3_mean = mean(aIV_3);
  ...
  fprintf(fid, 'a_0 =  %g*Rc^3 + %g*Rc^2 + %g*Rc + %g;\n', ...
          a0_0Fit(1),  a0_0Fit(2), a0_0Fit(3), a0_0Fit(4));
  fprintf(fid, 'aIV_0 =  %g*Rc^3 + %g*Rc^2 + %g*Rc + %g;\n', ...
          aIV_0Fit(1),  aIV_0Fit(2), aIV_0Fit(3), aIV_0Fit(4));
  fprintf(fid, 'a_1 =  %g*Rc^3 + %g*Rc^2 + %g*Rc + %g;\n', ...
          a0_1Fit(1),  a0_1Fit(2), a0_1Fit(3), a0_1Fit(4));
  fprintf(fid, 'aIV_1 =  %g*Rc^3 + %g*Rc^2 + %g*Rc + %g;\n', ...
          aIV_1Fit(1),  aIV_1Fit(2), aIV_1Fit(3), aIV_1Fit(4));
  fprintf(fid, 'a_2 =  %g*Rc^3 + %g*Rc^2 + %g*Rc + %g;\n', ...
          a0_2Fit(1),  a0_2Fit(2), a0_2Fit(3), a0_2Fit(4));
  fprintf(fid, 'aIV_2 =  %g*Rc^3 + %g*Rc^2 + %g*Rc + %g;\n', ...
          aIV_2Fit(1),  aIV_2Fit(2), aIV_2Fit(3), aIV_2Fit(4));
  fprintf(fid, 'a_3 =  %g*Rc^3 + %g*Rc^2 + %g*Rc + %g;\n', ...
          a0_3Fit(1),  a0_3Fit(2), a0_3Fit(3), a0_3Fit(4));
  fprintf(fid, 'aIV_3 =  %g*Rc^3 + %g*Rc^2 + %g*Rc + %g;\n', ...
          aIV_3Fit(1),  aIV_3Fit(2), aIV_3Fit(3), aIV_3Fit(4));
  fclose(fid);
...
function [theta0] = plotTangJCRc30Tension
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'ro-'); hold on;
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'g^-'); hold on;
  set(ptangiso, 'LineWidth', 3);
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'bp-'); hold on;
  set(ptangiso, 'LineWidth', 3);
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'md-'); hold on;
  set(ptangiso, 'LineWidth', 3);
...
function [theta0] = plotTangJCRc30Shear
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'rx-'); hold on;
  set(ptangiso, 'LineWidth', 3);
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'gs-'); hold on;
  set(ptangiso, 'LineWidth', 3);
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'bv-'); hold on;
  set(ptangiso, 'LineWidth', 3);
...
function [theta0] = plotTangLarsonRc38
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'gx-'); hold on;
  set(ptangiso, 'LineWidth', 3);
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'bs-'); hold on;
  set(ptangiso, 'LineWidth', 3);
...
function [theta0] = plotTangLYRc381500
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'mv-'); hold on;
  set(ptangiso, 'LineWidth', 3);
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'kd-'); hold on;
  set(ptangiso, 'LineWidth', 3);
...
function [theta0] = plotTangChiRc45_0001
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'r-o'); hold on;
  set(ptangiso, 'LineWidth', 3);
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'g-x'); hold on;
  set(ptangiso, 'LineWidth', 3);
  ...
  theta = theta*1.0e-6;
  ptangiso = plot(Fx, theta, 'b-s'); hold on;
  set(ptangiso, 'LineWidth', 3);
